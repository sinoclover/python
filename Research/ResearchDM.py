...
def dataMining(behance):
    count = 0
    # 修改文件
    data = open('data/data_for_useractID.csv', 'wt', newline='', encoding='utf_8_sig')
    ...
    try:
        ...
        for i in range(1, 100):
            ...
            projects = behance.project_search('', page=i, field='49', time='all', sort='appreciations')
...
def main():
    ...
    dataMining(behance)
    # 修改文件
    data = pd.read_csv('data/data_for_useractID.csv')
    print(data.head(5))
    # downloadPic(data)
